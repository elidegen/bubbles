...
export class ForgotpasswordComponent {
  ...
  reset() {
    if (this.forgotPasswordForm.valid) {
      ...
      this.mainService.errorLog('Please fill the field with a valid email adress');
    }
  }
  ...
  */
    resetPasswordRequest(url: string, formData: FormData) {
      ...
      this.http.post(url, formData).subscribe(res => {
        ...
        this.mainService.messageLog('Please check your mail! We`ve sended you a reset link');
        this.forgotPasswordForm.reset();
      }, error => {
        this.mainService.loader = false;
        this.mainService.errorLog('The request to reset your password failed');
      });
    }
